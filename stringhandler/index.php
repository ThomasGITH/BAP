	 ...
	 <body>
		...
		<div class="wrapper">
			...
			?><ul>
					...
					<li>String 1 getrimd trim():  <?php  echo $input1;  ?> </li>
                ...
                <li>De lengte van string 3 is:  <?php  echo strlen($input1.$input2);  ?> </li>
                ...
                <li>Zoek naar substring "PHP" vervang dit door "NodeJS" NodeJS<?php  echo str_replace("PHP","NodeJS",trim($input1).trim($input2));   ?> </li>
                <li>Wijzig de eerste letter van string 3 naar hoofdletter: <?php  echo ucfirst(trim($input1).trim($input2));   ?> </li>
                <li>Alles in hoofdletters: <?php  echo strtoupper(trim($input1).trim($input2));   ?> </li>
            </ul>
				<hr>
				<ol>
